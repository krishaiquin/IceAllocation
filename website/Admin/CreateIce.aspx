<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateIce.aspx.cs" MasterPageFile="~/MasterPage/MasterPage.master" Inherits="Admin_CreateIce" %>

<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
  <!--Author: Adrian & Jonathan-->
      <div>

        <h3>Create Ice Time</h3>
        <table>
            <tr>
                <td>Date:</td>
                <td>
			...
			<tr>
                ...
                <td>
                    ...
                    <asp:CheckBox ID="chkAssign" runat="server" AutoPostBack="True" OnCheckedChanged="chkAssign_CheckedChanged" Text="Unassigned" /><br />
                    <asp:Label ID="lblTeamMsg" runat="server" Text="" Visible="false" ForeColor="Red"></asp:Label>
                </td>
            </tr>
            <tr>
