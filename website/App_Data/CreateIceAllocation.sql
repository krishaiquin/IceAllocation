...
SET @database_name = N'IceAllocation'
...
, [CoachEmail] NVARCHAR(256)  NOT NULL  
, [ManagerEmail] NVARCHAR(256)  NULL  
, [GameBalance] INT  NOT NULL  
, [PracticeBalance] INT  NOT NULL  
, [WhoToEmail] CHAR(10)  NOT NULL 
, [Announcement] NVARCHAR(1000)  NULL   
, [ReceiveNotifications] NVARCHAR(5)
)
GO

ALTER TABLE [dbo].[Teams] ADD CONSTRAINT [Teams_PK] PRIMARY KEY CLUSTERED (
[TeamId]
)
GO
GO
...
, [RinkName] NVARCHAR(256) NOT NULL
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[IceTimes]') AND type in (N'U'))
    DROP TABLE [dbo].[IceTimes]
GO
CREATE TABLE [dbo].[IceTimes] (
[IceId] INT IDENTITY (1,1) NOT NULL  
...
, [IceType] NVARCHAR(256)  NOT NULL  
)
GO

ALTER TABLE [dbo].[IceTimes] ADD CONSTRAINT [IceTimes_PK] PRIMARY KEY CLUSTERED (
[IceId]
)
GO
GO
...
ALTER TABLE [dbo].[Requests] ADD CONSTRAINT [Requests_PK] PRIMARY KEY CLUSTERED (
[RequestId]
)
GO
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ReturnedIce]') AND type in (N'U'))
    DROP TABLE [dbo].[ReturnedIce]
GO
CREATE TABLE [dbo].[ReturnedIce] 
(
[IceId] INT NOT NULL
...
ALTER TABLE [dbo].[ReturnedIce] ADD CONSTRAINT [Returns_PK] PRIMARY KEY CLUSTERED (
[IceId]
)
GO
GO
...
, [ReviewingOn] NVARCHAR(5)
, [AppOpen] NVARCHAR(5)
, [LogoUrl] NVARCHAR(200)
, [Colour] NVARCHAR(20)
, [GameWindowWeekDayStart] TIME
, [GameWindowWeekDayFinish] TIME
, [GameWindowWeekEndStart] TIME
, [GameWindowWeekEndFinish] TIME
, [EmailAssignTemplate] NVARCHAR(1000)
, [EmailRejectTemplate] NVARCHAR(1000)
, [RollOverTime] INT
, [RollPracticeOver] INT
, [SiteTitle] NVARCHAR(30)
, [ReceiveNotifications] NVARCHAR(5)
, [TeamSchedulingOn] NVARCHAR(5)
)
GO
...
PRINT '-------------------------------------------'
PRINT 'Starting execution of Ice Allocation Setup'
PRINT '-------------------------------------------'


GO
GO
ALTER TABLE [dbo].[ReturnedIce] WITH CHECK ADD CONSTRAINT [IceTimes_Returns_FK1] FOREIGN KEY (
[IceId]
)
REFERENCES [dbo].[IceTimes] (
[IceId]
)
GO

ALTER TABLE [dbo].[IceTimes] WITH CHECK ADD CONSTRAINT [Teams_IceTimes_FK1] FOREIGN KEY (
[TeamId]
)
REFERENCES [dbo].[Teams] (
[TeamId]
)
ALTER TABLE [dbo].[ReturnedIce] WITH CHECK ADD CONSTRAINT [Teams_Returns_Returner_FK2] FOREIGN KEY (
[ReturnerId]
)
REFERENCES [dbo].[Teams] (
[TeamId]
...
ALTER TABLE [dbo].[ReturnedIce] WITH CHECK ADD CONSTRAINT [Teams_Returns_Assigned_FK3] FOREIGN KEY (
[AssignedId]
)
REFERENCES [dbo].[Teams] (
[TeamId]
...
ALTER TABLE [dbo].[IceTimes] WITH CHECK ADD CONSTRAINT [IceTimes_Locations_FK3] FOREIGN KEY (
[LocationId]
)
...
ALTER TABLE [dbo].[Requests] WITH CHECK ADD CONSTRAINT [Teams_Requests_FK1] FOREIGN KEY (
[TeamId]
)
REFERENCES [dbo].[Teams] (
[TeamId]
)
ALTER TABLE [dbo].[Requests] WITH CHECK ADD CONSTRAINT [Returns_Requests_FK1] FOREIGN KEY (
[IceId]
)
REFERENCES [dbo].[ReturnedIce] (
[IceId]
)
GO


ALTER TABLE [dbo].[Teams] WITH CHECK ADD CONSTRAINT [aspnet_users_Teams_FK1] FOREIGN KEY (
[UserId]
)
...
Declare @AdminRole NVARCHAR(4000)
set @AdminRole = 'Administrator'

Declare @TeamRole NVARCHAR(4000)
set @TeamRole = 'Team'



exec aspnet_Applications_CreateApplication @AppName,@AppID ;
exec aspnet_Roles_CreateRole  @AppName, @AdminRole;
exec aspnet_Roles_CreateRole  @AppName,@TeamRole;


Declare @AdminName NVARCHAR(256)
SET @AdminName = 'admin'

DECLARE @AdminPassword NVARCHAR(128)
...
SET @Email='seafairiceallocator@gmail.com'

DECLARE @UniqueEmail int
SET @Email=1

DECLARE @PasswordQuestion NVARCHAR(256)
SET @PasswordQuestion = 'What is the question?'

DECLARE @PasswordAnswer NVARCHAR(256)
SET  @PasswordAnswer = 'unkown'
...
exec aspnet_Membership_CreateUser @AppName, @AdminName, @AdminPassword, @Salt,@Email, @PasswordQuestion,@PasswordAnswer,
@IsApproved,@CurrentDate,@CurrentDate, @UniqueEmail, @PasswordFormat,@UserId;

exec aspnet_UsersInRoles_AddUsersToRoles @AppName, @AdminName, @AdminRole, @CurrentDate;




INSERT INTO Settings ( [Announcement] , [AdminEmail] , [ReviewingOn] , [AppOpen] , [LogoUrl] , [Colour] , [GameWindowWeekDayStart]
, [GameWindowWeekDayFinish], [GameWindowWeekEndStart], [GameWindowWeekEndFinish], [EmailAssignTemplate], [EmailRejectTemplate], [RollOverTime], [RollPracticeOver], [SiteTitle] )
VALUES('', @Email, 'false', 'true', '', '', '17:00', '22:00', '07:00', '23:00', '', '', 48, 0 , 'Seafair Minor Ice Hockey');


PRINT '-------------------------------------------'
PRINT 'Completed execution of Ice Allocation Setup'
PRINT '-------------------------------------------'